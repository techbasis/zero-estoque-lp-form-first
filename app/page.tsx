      ...
      <div className="relative z-10">
        ...
        <section className="py-16 sm:py-24 lg:py-32">
          <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
            <div className="grid items-center gap-8 sm:gap-12 lg:grid-cols-2 lg:gap-16">
              ...
              >
                <h2 className="text-2xl font-bold tracking-tight text-balance text-white sm:text-3xl lg:text-4xl">
                  A metodologia que transforma estoque parado em carros vendidos todo mês.
                </h2>
                <p className="mt-4 text-base leading-7 text-pretty text-gray-300 sm:mt-6 sm:text-lg sm:leading-8">
                  ...
                  REAIS. Enquanto o mercado se perde em likes, branding e "marca aparecendo", nossa
                  metodologia Zera Estoque ataca o seu maior problema: carro parado no pátio.
                  Estruturamos um plano com 3 pilares: Criativos Anti-Curiosos, Tráfego com foco em
                  estoque e Metodologia de vendas e fechamento.
                </p>
              ...
              <motion.div
                ...
                className="mx-auto mt-8 grid max-w-5xl grid-cols-2 gap-4 sm:gap-6 lg:mt-16 lg:gap-8"
              >
                {[
                  { value: '23+', label: 'Projetos Automotivos' },
                  { value: '900+', label: 'Veiculos vendidos' },
                  { value: '100%', label: 'Foco em ROI' },
                  { value: '5+', label: 'Anos no Mercado' },
                ].map((stat, index) => (
                  <motion.div key={index} variants={fadeInUp}>
                    <Card className="group border-white/10 bg-black/50 backdrop-blur-sm transition-all duration-300 hover:scale-105 hover:border-blue-500/30 hover:shadow-[0_0_30px_rgba(59,130,246,0.2)]">
                      <CardContent className="p-6 text-center sm:p-8">
                        <div className="text-4xl font-bold text-blue-500 sm:text-5xl lg:text-4xl">
                          {stat.value}
                        </div>
                        <div className="mt-2 text-sm text-gray-400 sm:mt-3 sm:text-base">
                          {stat.label}
                        </div>
                      </CardContent>
                    </Card>
            ...
            {/* Video explicativo - Centralizado */}
            <motion.div
            ...
            >
              <div className="relative aspect-[9/16] w-full max-w-[280px] overflow-visible rounded-lg border-2 border-blue-500 shadow-[0_0_30px_rgba(59,130,246,0.4)] transition-all duration-300 hover:shadow-[0_0_70px_rgba(59,130,246,0.6)] sm:max-w-sm sm:border-4 sm:shadow-[0_0_50px_rgba(59,130,246,0.4)]">
                ...
                <div className="absolute -right-4 -bottom-4 rounded-xl border border-blue-400 bg-black px-2.5 py-1.5 shadow-lg sm:-right-6 sm:-bottom-6 sm:rounded-2xl sm:border-2 sm:px-4 sm:py-2">
                  ...
                  <div className="text-xs font-semibold text-blue-400 sm:text-sm">Engajamento</div>
                </div>
              </div>
            </motion.div>
          </div>
          ...
          <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
            ...
            >
              ...
              <h2 className="mb-4 text-2xl font-bold tracking-tight text-white sm:text-3xl lg:text-4xl">
                Cansado de promessas vazias? Veja a diferença entre agências genéricas e uma
                Aceleradora Comercial especializada em automotivo.
              </h2>
              <p className="text-base text-gray-300 sm:text-lg">
                Você já investiu em tráfego e não sentiu o resultado no estoque.
                <br />O problema não é o anúncio, é a forma como ele é usado dentro da sua operação.
              </p>
            </motion.div>
            ...
            >
              ...
              <div className="overflow-hidden rounded-2xl border border-white/10 bg-gradient-to-br from-gray-900/50 to-black/50 backdrop-blur-sm">
                {/* Header */}
                <div className="grid grid-cols-2 border-b border-white/10">
                  <div className="border-r border-red-500/30 bg-gradient-to-br from-red-950/20 to-gray-900/30 p-4 text-center sm:p-6">
                    <h3 className="text-base font-semibold text-red-400 sm:text-lg">
                      Agências Comuns
                    </h3>
                    <p className="text-sm text-red-300/60">Gestores Genéricos</p>
                  </div>
                  <div className="border-l border-blue-500/30 bg-gradient-to-br from-blue-900/30 to-blue-950/20 p-4 text-center sm:p-6">
                    <h3 className="text-base font-semibold text-blue-400 sm:text-lg">
                      Basis Aceleradora
                    </h3>
                    <p className="text-sm text-blue-500/80">Comercial Automotiva</p>
                  </div>
                </div>

                {/* VS Badge */}
                <div className="absolute top-[88px] left-1/2 z-10 -translate-x-1/2 rounded-full border-2 border-blue-500 bg-gray-900 px-4 py-2 shadow-[0_0_20px_rgba(59,130,246,0.4)]">
                  <span className="text-sm font-bold text-blue-400 sm:text-base">VS</span>
                </div>
                ...
                {[
                  ...
                  },
                  {
                    ...
                    basis: (
                      <>
                        ...
                        <br />
                        focadas em carros vendidos
                        <br />e próximos passos
                      </>
                    ),
                  },
                  {
                  ...
                  return (
                    ...
                    >
                      ...
                      <div className="flex flex-col items-center justify-center border-r border-red-500/30 bg-gradient-to-br from-red-950/20 to-gray-900/10 p-4 text-center sm:p-6">
                        <div className="mb-3 flex items-center justify-center gap-2 sm:gap-3">
                          <Icon className="h-5 w-5 flex-shrink-0 text-red-400 sm:h-6 sm:w-6" />
                          <span className="text-sm font-semibold text-red-300 sm:text-base">
                            {row.label}
                          </span>
                        </div>
                      ...
                      <div className="flex flex-col items-center justify-center border-l border-blue-500/30 bg-gradient-to-br from-blue-900/30 to-blue-950/10 p-4 text-center sm:p-6">
                        <div className="mb-3 flex items-center justify-center gap-2 sm:gap-3">
                          <Icon className="h-5 w-5 flex-shrink-0 text-green-400 sm:h-6 sm:w-6" />
                          <span className="text-sm font-semibold text-green-300 sm:text-base">
                            {row.label}
                          </span>
                        </div>
                        <p className="text-xs leading-relaxed font-medium text-white sm:text-sm">
                          {row.basis}
                        </p>
                      </div>
                    </div>
              ...
              <motion.div variants={fadeInUp} className="mt-8 text-center sm:mt-12">
                <Button
                  onClick={scrollToForm}
                  size="lg"
                  className="w-full bg-blue-600 text-white transition-all duration-300 hover:scale-105 hover:bg-blue-700 hover:shadow-[0_0_30px_rgba(59,130,246,0.6)] sm:w-auto sm:px-8"
                >
            ...
            <div className="mx-auto max-w-2xl text-center">
              ...
              {!showForm ? (
                <Button
                  onClick={scrollToForm}
                  size="lg"
                  className="relative w-full rounded-xl bg-blue-600 px-8 py-5 text-base font-semibold text-white shadow-[0_0_30px_rgba(59,130,246,0.5)] transition-all duration-300 hover:scale-105 hover:bg-blue-700 hover:shadow-[0_0_50px_rgba(59,130,246,0.7)] sm:w-auto sm:px-12 sm:py-6 sm:text-lg"
                >
                  Preencher Formulário
                </Button>
              ) : (
                <div className="animate-in fade-in slide-in-from-top-4 mt-8 duration-500 sm:mt-12">
                  ...
                  {submitStatus === 'error' && (
                    <div className="mb-4 rounded-xl border-2 border-red-500/50 bg-red-500/10 p-4 shadow-[0_0_30px_rgba(239,68,68,0.3)] sm:mb-6 sm:p-6">
                      <p className="text-sm font-semibold text-red-400 sm:text-lg">
                        {submitMessage}
                      </p>
                    </div>
                  )}
